<template>
    <div>
      <b-button variant="info" v-b-modal.employee-modal-2 @click="erase"><pre>Update      <br>   Employee</pre> </b-button>
      <b-modal
        id="employee-modal-2"
        ref="modal"
        title="Updating New Employee"
  ...
  export default {
    ...
    methods: {
      ...
      handleSubmit() {
        this.$nextTick(() => {
          this.$bvModal.hide("employee-modal-2");
        });
      },
    },
  };
