 ...
 <b-form-group
  ...
  export default {
    ...
    mounted() {
      ...
      this.employeeAssign=JSON.parse(localStorage.getItem('listtasks')) || [];
    ...
    this.employeeAssign.push({
     ...
     localStorage.setItem('listtasks',JSON.stringify(this.employeeAssign)) ;
     },
      ...
      retrieveEmployeesFromLocalStorage() {
        ...
        const savedTask = localStorage.getItem("listtasks");
        if (savedTask) {
