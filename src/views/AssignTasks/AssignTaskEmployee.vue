<template>
 ...
 <b-form-group
        ...
        >
        <b-form-input type='date' v-model="form.startdate" id="date1"></b-form-input>
        </b-form-group>
        ...
        <b-form-group
          ...
          invalid-feedback="date is required"
        >
        <b-form-input type='date' v-model="form.startdate" id="date2"></b-form-input>
        </b-form-group>
...
import ListEmployeeTask from "./ListEmployeeTask.vue";
